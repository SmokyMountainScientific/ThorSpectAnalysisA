...
/* for (int s = 0; s<3; s++){
 ...
 void mouseDragged(){
   int sens = 15;  // define sensitivity
 ...
 //    println("f0 calculated: "+xZ0+" / "+iDx+" = "+fBox[0]);
     int pixelF0 = int(fBox[0]*(nPixels-1));
     float wavelengthF0 = xVal[pixelF0];
     println("pixel 0: "+ pixelF0+" wavelength 0: "+ wavelengthF0); 

//     println("f1 calculated: "+xZ1+" / "+iDx+" = "+fBox[1]);
     int pixelF1 = int(fBox[1]*(nPixels-1));
     float wavelengthF1 = xVal[pixelF1];
